 ...
 */
public class CdpDeviceRequestPrompt extends DeviceRequestPrompt {
    ...
    public CdpDeviceRequestPrompt(CDPSession client, TimeoutSettings timeoutSettings, DeviceRequestPromptedEvent firstEvent) {
        this.client = client;
    ...
    public void select(DeviceRequestPromptDevice device) {
        ...
        this.client.send("DeviceAccess.selectPrompt", new HashMap<String, Object>() {{
            put("id", CdpDeviceRequestPrompt.this.id);
