...
public abstract class Keyboard {
     ...
     * @param cha 要发送到页面的字符。
     */
    public abstract void sendCharacter(String cha) throws JsonProcessingException;
     ...
     * @param options 选项
     */
    public abstract void type(String text, KeyboardTypeOptions options);
     ...
     * @param options 选项
     */
    public abstract void press(String key, KeyPressOptions options);

    /**
     * 调度 keyup 事件。
     *
     * @param key 要释放的健的名称，具体有哪些健见 {@link Keyboard#keyDefinitions}
     */
    public abstract void up(String key);
    protected static final Map<String, KeyDefinition> keyDefinitions = new HashMap<>();
