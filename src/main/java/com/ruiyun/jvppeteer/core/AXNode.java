...
import com.ruiyun.jvppeteer.entities.AXProperty;
...
public class AXNode {
    ...
    private com.ruiyun.jvppeteer.entities.AXNode payload;
    ...
    public AXNode(Realm realm, com.ruiyun.jvppeteer.entities.AXNode payload) {
    ...
    public static AXNode createTree(Realm realm, List<com.ruiyun.jvppeteer.entities.AXNode> payloads) {
        Map<String, AXNode> nodeById = new HashMap<>();
        for (com.ruiyun.jvppeteer.entities.AXNode payload : payloads)
    ...
    public com.ruiyun.jvppeteer.entities.AXNode getPayload() {
        return payload;
    }

    public void setPayload(com.ruiyun.jvppeteer.entities.AXNode payload) {
        this.payload = payload;
    }
