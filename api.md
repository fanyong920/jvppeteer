...
# Jvppeteer API <!-- GEN:version -->Tip-Of-Tree<!-- GEN:stop-->
...
[puppeteer.connect](####puppeteer.connect(options)) 可以将浏览器 websocket 端作为一个参数。其格式为 `ws://${host}:${port}/devtools/browser/<id>`。
