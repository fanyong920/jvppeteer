...
```xml
compile "io.github.fanyong920:jvppeteer:3.6.3"
```
...
|    3.6.3     | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 149.0.7798.0  & Firefox stable_149.0 |
| :----------: | :----------------------------------------------------------: |
