...
```xml
compile "io.github.fanyong920:jvppeteer:3.4.1"
```
...
| 3.4.0-3.4.1  | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 137.0.7151.119  & Firefox stable_139.0.4 |
|:------------:| :----------------------------------------------------------: |
