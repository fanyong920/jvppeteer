...
```xml
compile "io.github.fanyong920:jvppeteer:3.5.0"
```
...
|    3.5.0-    | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 142.0.7444.175  & Firefox stable_145.0.1 |
| :----------: | :----------------------------------------------------------: |
