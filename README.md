...
```xml
compile "io.github.fanyong920:jvppeteer:3.3.7"
```
...
| 3.3.6-3.3.7  | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 135.0.7049.42  & Firefox stable_137.0 |
|:------------:| :----------------------------------------------------------: |
