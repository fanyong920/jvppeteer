...
```xml
compile "io.github.fanyong920:jvppeteer:3.6.4"
```
...
| 3.6.3-3.6.4  | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 149.0.7798.0  & Firefox stable_149.0 |
|:------------:| :----------------------------------------------------------: |
| 3.5.0- 3.6.2 | [Chrome for Testing](https://googlechromelabs.github.io/chrome-for-testing/#stable) 142.0.7444.175  & Firefox stable_145.0.1 |
